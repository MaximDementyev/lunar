...
struct Vector2 &operator + (struct Vector2, struct Vector2);
struct Vector2 &operator - (struct Vector2, struct Vector2);
struct Vector2 &operator - (struct Vector2);
struct Vector2 &operator * (struct Vector2, double);
struct Vector2 &operator * (double, struct Vector2);
struct Vector2 &operator *= (struct Vector2, double);
struct Vector2 &operator / (struct Vector2, double);
