...
void next_step_no_N(FILE*, struct state_model* const, const struct koef_of_model*, const struct surface*, double *time_left, double all_time_step);
...
int touch_test(state_model* , const struct koef_of_model* , const surface* , double *current_surface_height);
